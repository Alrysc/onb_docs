...
* Status interactions with each other is more accurate
...
If your mod changes the `Player.charge_attack_func`, consider also changing the `Player.charged_time_func` 
